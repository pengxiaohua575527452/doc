 ...
 */
class RBTreeNode {
    constructor(key = null, data = null, color = RED, left = null, right = null, parent = null) {
        if (key === null) {
...
class RBTree {
    ...
    fixAfterDel(fixNode) {
        ...
        // 从下往上处理
        while (this.getColor(fixNode) === BLACK
            && fixNode !== this.root
            && fixNode.parent) {
            let sibling;
