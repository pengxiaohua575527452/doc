...
(function (Strategy) {
    ...
    class BaseSalary {
        constructor(salary) {
            let __salary = salary;
            this.setBaseSalary = function (salary) {
                __salary = salary;
            };
     ...
     * @returns
     */
    let createAlgorithm = function (opts) {
        let o = {};
        for (let key in opts) {
            o[key] = function (baseSalary) {
                return opts[key] * baseSalary;
            };
        }
        return o;
    };
    ...
    class Bonus {
        constructor(algorithm) {
            this.getBonus = function (perforamnce, baseSalary) {
                return algorithm[perforamnce](baseSalary);
            };
            this.setAlgorithm = function (newAlgorithem) {
    ...
    class Employee extends Person {
        constructor(name, salary, performance, opts) {
            super(name);
    ...
    // 测试雇员类
    let jack = new Employee("jack", 3000, "S", { S: 6, A: 3, B: 1 });
