...
(function (VirtualProxy) {
     ...
     * 真正的插入一个imag节点的类
     */
    class AppendChildImage {
        constructor(src, className, container) {
            ...
            this.insert = function (container) {
                var _a;
                (_a = _img_.parentElement) === null || _a === void 0 ? void 0 : _a.removeChild(_img_);
                container.appendChild(_img_);
                return this;
            };
...
var VirtualProxy2;
(function (VirtualProxy2) {
    /**
     * 基础类
     * 设置 img.src
     */
    let setSrc = function (_img_, src) {
        _img_.setAttribute("src", src);
        return _img_;
    };
    /**
    ...
    let setSrcProxy = function (_img_, src) {
